...
<head>
    <script src="bootstrap-5.3.2-examples/assets/js/color-modes.js"></script>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="">
    <meta name="author" content="Ahmad Khoirul Falah">
    ...
    <link href="bootstrap-5.3.2-examples/sign-in/sign-in.css" rel="stylesheet">
</head>
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <form action="cek_login.php" method="post">
        <img class="mb-4" src="bootstrap-5.3.2-examples/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57">
